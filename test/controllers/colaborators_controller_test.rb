...
class ColaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create colaborator" do
    assert_difference("Colaborator.count") do
      post colaborators_url, params: { colaborator: { email: @colaborator.email, name: @colaborator.name, phone: @colaborator.phone, role: @colaborator.role } }
    end
  ...
  test "should update colaborator" do
    patch colaborator_url(@colaborator), params: { colaborator: { email: @colaborator.email, name: @colaborator.name, phone: @colaborator.phone, role: @colaborator.role } }
